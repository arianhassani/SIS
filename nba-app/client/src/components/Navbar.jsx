...
const Navbar = () => {
  ...
  return (
    <div
      className="bg-neutral text-neutral-content shadow-lg rounded-lg mt-4 mx-auto"
        ...
        <div className="flex-none">
          ...
          <ul className="steps">
            <li className={getStepClass('/')}>
              <span className="text-neutral-content">Team Selection</span>
            </li>
            <li className={getStepClass('/injury-page')}>
              <span className="text-neutral-content">Injury</span>
            </li>
            <li className={getStepClass('/matchup-page')}>
              <span className="text-neutral-content">Match-Up</span>
            </li>
            <li className={getStepClass('/prediction-page')}>
              <span className="text-neutral-content">Prediction</span>
            </li>
          </ul>
        </div>
      </div>
