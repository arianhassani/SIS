      ...
      <div className="card bg-base-300 rounded-box p-4 w-full">
        <div className="flex flex-col lg:flex-row w-full space-y-4 lg:space-y-0 lg:space-x-4 justify-between">
          ...
          <div className="flex-grow grid place-items-center p-4">
            <h3 className="text-xl font-semibold mb-4">Team 1 Top Performer</h3>
            <TopPerformer/>
          </div>
          {/* Top Performer 2 */}
          <div className="flex-grow grid place-items-center p-4">
            <h3 className="text-xl font-semibold mb-4">Team 2 Top Performer</h3>
            <TopPerformer/>
          </div>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="card shadow-lg bg-base-100 p-4">
          <div className="card-body">
            <h3 className="card-title">Team 1 Graph</h3>
        ...
        <div className="card shadow-lg bg-base-100 p-4">
          <div className="card-body">
            <h3 className="card-title">Team 2 Graph</h3>
            {/* Placeholder for Graph */}
            <div className="w-full h-64 bg-gray-200 rounded-lg"></div>
          </div>
        </div>
        ...
        <div className="card shadow-lg bg-base-100 p-4">
          <div className="card-body">
            <h3 className="card-title">Team 1 Top Performer Scatterplot</h3>
        ...
        <div className="card shadow-lg bg-base-100 p-4">
          <div className="card-body">
            <h3 className="card-title">Team 2 Top Performer Scatterplot</h3>
            {/* Placeholder for Scatterplot */}
            <div className="w-full h-64 bg-gray-200 rounded-lg"></div>
          </div>
        </div>
