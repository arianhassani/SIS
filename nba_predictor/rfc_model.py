...
def get_prediction(team_1_id,_team_2_id,team_1_home_flag_init):
    dataset = pd.read_csv('../combined_team_data/combined_data_set/team_dataset_final.csv')
    model = joblib.load('../nba_predictor/rcf_mod.pkl')
    ...
    return home_team_win_result, predict_prob